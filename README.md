...
| 	2.		| JavaTechie - Deploy springboot application along with mysql				| 7741f0ef57fa714bd5ed42b57d0adf96fe9f4807				|


### How to get certain commit from GitHub project
------------------------------------------------
1. First, clone the repository using git as shown below
git clone https://github.com/premvinodh/JavaTechieKubernetes.git
That downloads the complete history of the repository, so you can switch to any version. Next, change into the newly cloned repository:

2. cd <complete_path_on_your_system>\JavaTechieKubernetes

3. Use git checkout <COMMIT> to change to the right commit of a particular topic
git checkout 7a226f5ff2e1c9881397af9c05dc7500364a9737
